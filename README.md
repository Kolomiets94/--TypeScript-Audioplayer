...
🔗 **GitHub репозиторий:** [Kolomiets94/--TypeScript-Audioplayer](https://github.com/Kolomiets94/--TypeScript-Audioplayer)
...
5. **Запустить фронтенд приложение**
   ```bash
   npm start
   ```
...
- За предоставленный бэкенд (Express + JWT)
- За дизайн-макет и вдохновение
